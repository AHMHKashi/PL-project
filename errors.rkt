...
(define (report-no-binding-found function search-var)
  (eopl:error function "No binding for ~s" search-var))
...
(define (report-arguments-len-long function)
  (eopl:error function "Arguments length is too long."))
